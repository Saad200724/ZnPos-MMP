  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto h-full flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">Track incoming inventory and purchase orders</p>
      </div>
      ...
      <div className="flex-1 bg-card rounded-2xl border border-card-border shadow-sm flex flex-col items-center justify-center p-8 text-center">
        ...
        <h2 className="text-xl font-display font-bold text-card-foreground mb-2">Purchases Module Under Construction</h2>
        <p className="text-muted-foreground max-w-md">
          This section will contain purchase orders, received items, and supplier invoices.
        </p>
      </div>
    </div>
  );
